...
module FF_EasyEP_TosiFumi_Cut
  ...
  type, extends(EasyPair_Cut) :: TosiFumi_Cut
    ...
    contains
      procedure, pass :: Constructor => Constructor_TosiFumi_Cut
      procedure, pass :: PairFunction => PairFunction_TosiFumi_Cut
      procedure, pass :: ProcessIO => ProcessIO_TosiFumi_Cut
  end type

  contains
  !=============================================================================+
  subroutine Constructor_TosiFumi_Cut(self)
    use Common_MolInfo, only: nAtomTypes
    implicit none
    class(TosiFumi_Cut), intent(inout) :: self
    ...
    IF (AllocateStat /= 0) error STOP "Allocation error in TosiFumi_Cut"
  ...
  !======================================================================+
  function PairFunction_TosiFumi_Cut(self, rsq, atmtype1, atmtype2) result(E_Pair)
    use Common_MolInfo, only: nAtomTypes
    implicit none
    class(TosiFumi_Cut), intent(inout) :: self
    ...
    real(dp) :: r, r6, A_ij, rho_ij, C6_ij
  ...
  !=====================================================================
  subroutine ProcessIO_TosiFumi_Cut(self, line)
    ...
    real(dp) :: realVal, A_val, rho_val, C6_val
  ...
  !=====================================================================
  subroutine ComputeEShift(self, iType, jType)
    implicit none
    class(TosiFumi_Cut), intent(inout) :: self
    integer, intent(in) :: iType, jType

    real(dp) :: r, r6, E_Rep, E_Disp, EShift_val
