...
module Constrain_DistanceCriteria
  ...
  type, public, extends(constraint) :: RadiusGyration
    integer :: neighList = 1
    integer :: molType = 1
    integer :: atomNum = 1
    real(dp) :: rCut, rCutSq
    ...
    contains
      procedure, pass :: Constructor => RadGyr_Constructor
      procedure, pass :: CheckInitialConstraint => RadGyr_CheckInitialConstraint
      procedure, pass :: DiffCheck => RadGyr_DiffCheck
!      procedure, pass :: CheckCluster => RadGyr_CheckCluster
      procedure, pass :: ProcessIO => RadGyr_ProcessIO
      procedure, pass :: Maintenance => RadGyr_Maintenance
      procedure, pass :: Update => RadGyr_Update
      procedure, pass :: Epilogue => RadGyr_Epilogue
  end type
!=====================================================================
  contains
!=====================================================================
  subroutine RadGyr_Constructor(self, boxID)
...
!=====================================================================
  subroutine RadGyr_CheckInitialConstraint(self, trialBox, accept)
    implicit none
    class(RadiusGyration), intent(inout) :: self
...
!=============================================================
  subroutine RadGyr_DiffCheck(self, trialBox, disp, accept)
    implicit none
    class(RadiusGyration), intent(inout) :: self
    class(SimBox), intent(in) :: trialBox
...
!              write(*,*) "Del", iMol
      ...
      class is(NewState_IsoMol)
        ...
        do iMol = 1, totalMol-1
          ...
          enddo
        enddo
        if(all(self%newTopoList .eqv. .false.)) then
          accept = .false.
          return
        endif
        self%clustMemb = .false.
...
!=============================================================
  subroutine RadGyr_ProcessIO(self, line, lineStat)
...
!====================================================================
  subroutine RadGyr_Maintenance(self)
    implicit none
    class(RadiusGyration), intent(inout) :: self

  end subroutine
!====================================================================
  subroutine RadGyr_Epilogue(self)
    implicit none
    class(RadiusGyration), intent(inout) :: self
    logical :: accept
