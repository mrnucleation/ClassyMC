...
! is not guarenteed.
! To use apply the "extends(Pair_EasyPairCut)" 
!================================================================================
module FF_Pair_EasyPairCut
  use Template_ForceField, only: ForceField
  use VarPrecision
  use Template_SimBox, only: SimBox
  use CoordinateTypes

  type, extends(forcefield) :: Pair_EasyPairCut
    real(dp), allocatable :: rMin(:)
    real(dp), allocatable :: rMinTable(:,:)
!    real(dp) :: rCut, rCutSq
    contains
!      procedure, pass :: Constructor => Constructor_EasyPairCut
      procedure, pass :: DetailedECalc => Detailed_EasyPairCut
      procedure, pass :: DiffECalc => DiffECalc_EasyPairCut
      procedure, pass :: ShiftECalc_Single => Shift_EasyPairCut_Single
      procedure, pass :: ShiftECalc_Multi => Shift_EasyPairCut_Multi
      procedure, pass :: NewECalc => New_EasyPairCut
      procedure, pass :: OldECalc => Old_EasyPairCut
!      procedure, pass :: ProcessIO => ProcessIO_EasyPairCut
      procedure, pass :: GetCutOff => GetCutOff_EasyPairCut
      procedure, pass :: ComputePair => GetCutOff_EasyPairCut
  end type

  contains
  !=============================================================================+
  subroutine Constructor_EasyPairCut(self)
    use Common_MolInfo, only: nAtomTypes
    implicit none
    class(Pair_EasyPairCut), intent(inout) :: self
...
!============================================================================
  subroutine DiffECalc_EasyPairCut(self, curbox, disp, tempList, tempNNei, E_Diff, accept)
    implicit none
    class(Pair_EasyPairCut), intent(inout) :: self
...
!        stop
      class default
        write(*,*) "Unknown Perturbation Type Encountered by the EasyPairCut Pair Style."
    end select


  end subroutine
  !===================================================================================
  subroutine Detailed_EasyPairCut(self, curbox, E_T, accept)
...
!    write(nout,*) "Lennard-Jones Energy:", E_Pair
  ...
  !=====================================================================
  subroutine Shift_EasyPairCut_Single(self, curbox, disp, E_Diff, accept)
    implicit none
    class(Pair_EasyPairCut), intent(inout) :: self
    class(SimBox), intent(inout) :: curbox
...
!      write(*,*) iAtom, curbox%NeighList(1)%list(:, iAtom)
  ...
  !=====================================================================
  subroutine Shift_EasyPairCut_Multi(self, curbox, disp, E_Diff)
    implicit none
      class(Pair_EasyPairCut), intent(inout) :: self
      class(SimBox), intent(inout) :: curbox
      type(displacement), intent(in) :: disp(:)
  ...
  !=====================================================================
  subroutine New_EasyPairCut(self, curbox, disp, tempList, tempNNei, E_Diff, accept)
    implicit none
    class(Pair_EasyPairCut), intent(inout) :: self
    class(SimBox), intent(inout) :: curbox
!    type(displacement), intent(in) :: disp(:)
...
!          write(*,*) iAtom, jAtom, rsq, Pair
  ...
  !=====================================================================
  subroutine Old_EasyPairCut(self, curbox, disp, E_Diff)
    implicit none
    class(Pair_EasyPairCut), intent(inout) :: self
    class(SimBox), intent(inout) :: curbox
!    type(displacement), intent(in) :: disp(:)
  ...
  !=============================================================================+
  function GetCutOff_EasyPairCut(self) result(rCut)
    implicit none
    class(Pair_EasyPairCut), intent(inout) :: self
    real(dp) :: rCut
  ...
  !=============================================================================+
  function ComputePair_EasyPairCut(self, rsq, atmType1, atmType2) result(energy)
    implicit none
    class(Pair_EasyPairCut), intent(inout) :: self
